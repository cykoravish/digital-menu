...
import { Store, ChefHat, ShoppingBag, DollarSign, TrendingUp, Clock, QrCode } from "lucide-react"
...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (user?.restaurant) {
        const restaurantResponse = await axios.get(`http://localhost:5000/api/restaurants/${user.restaurant._id}`)
        ...
        // Fetch orders
        const ordersResponse = await axios.get("http://localhost:5000/api/orders/restaurant/my-orders?limit=5")
